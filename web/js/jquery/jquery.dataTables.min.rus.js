...
(function (Ea, Q, k) {
    var P = function (h) {
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Показано: _START_ - _END_.  Всего записей: _TOTAL_.",
                sInfoEmpty: "Показано: 0.  Всего записей: 0.",
                sInfoFiltered: "(Фильтрация из _MAX_ записи)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
    ...
    "function" === typeof define && define.amd ? define("datatables", [""], P) : "object" === typeof exports ? module.exports = P(require("jquery")) : jQuery && !jQuery.fn.dataTable && P(jQuery)
})(window, document);
